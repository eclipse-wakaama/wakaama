...
set(LWM2M_VERSION "1.1.1" CACHE STRING "LWM2M version for client and max LWM2M version for server.")
if(LWM2M_VERSION VERSION_EQUAL "1.0")
    set(WAKAAMA_DEFINITIONS ${WAKAAMA_DEFINITIONS} -DLWM2M_VERSION_1_0)
endif()
if(LWM2M_VERSION VERSION_EQUAL "1.1")
    set(WAKAAMA_DEFINITIONS ${WAKAAMA_DEFINITIONS} -DLWM2M_VERSION_1_1)
endif()
if(LWM2M_VERSION VERSION_EQUAL "1.1.1")
    set(WAKAAMA_DEFINITIONS ${WAKAAMA_DEFINITIONS} -DLWM2M_VERSION_1_1_1)
endif()
