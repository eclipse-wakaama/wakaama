                                 ...
                                 lwm2m_server_t * bootstrapServer)
{
    ...
    if (bootstrapServer->sessionH != NULL)
    {
        ...
        transaction = transaction_new(bootstrapServer->sessionH, COAP_TYPE_CON, COAP_POST, NULL, NULL, context->nextMID++, 4, NULL);
        if (transaction == NULL)
        {
            bootstrapServer->status = STATE_BS_FAILED;
            return;
                           ...
                           lwm2m_uri_t * uriP)
{
    ...
    LOG_URI(uriP);
    transaction = transaction_new(sessionH, COAP_TYPE_CON, COAP_DELETE, NULL, uriP, contextP->nextMID++, 4, NULL);
                          ...
                          size_t length)
{
    ...
    transaction = transaction_new(sessionH, COAP_TYPE_CON, COAP_PUT, NULL, uriP, contextP->nextMID++, 4, NULL);
    if (transaction == NULL) return COAP_500_INTERNAL_SERVER_ERROR;
                           ...
                           void * sessionH)
{
    ...
    LOG("Entering");
    transaction = transaction_new(sessionH, COAP_TYPE_CON, COAP_POST, NULL, NULL, contextP->nextMID++, 4, NULL);
    if (transaction == NULL) return COAP_500_INTERNAL_SERVER_ERROR;
