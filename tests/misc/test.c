...
int main(int argc, char *argv[])
{
    ...
    char * tests[]={"12", "-114" , "919293949596979899", "-98979969594939291", "999999999999999999999999999999", "1.2" , "0.134" , "432f.43" , "0.01", "1.00000000000002", NULL};
    int64_t ints[]={12, -114 , 1 , 134 , 43243 , 0, -215025, 0xFF};
    double floats[]={12, -114 , 1.02 , 134.000235 , 0.43243 , 0, -21.5025, -0.0925, 0.98765, 0xFF};
