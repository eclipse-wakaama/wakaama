    ...
    ((M) == LWM2M_CONTENT_TEXT                                                                                         \
         ...
         : ((M) == LWM2M_CONTENT_LINK                                                                                  \
                ...
                : ((M) == LWM2M_CONTENT_OPAQUE                                                                         \
                       ...
                       : ((M) == LWM2M_CONTENT_TLV                                                                     \
                              ? "TLV"                                                                                  \
                              : ((M) == LWM2M_CONTENT_JSON                                                             \
                                     ? "JSON"                                                                          \
                                     : ((M) == LWM2M_CONTENT_SENML_JSON ? "SenML JSON" : "Unknown"))))))
#endif

static void senml_json_test_data(const char *uriStr, lwm2m_media_type_t format, lwm2m_data_t *tlvP, int size,
                                 const char *id) {
    lwm2m_uri_t uri;
    uint8_t *buffer;
    int length;
...
static void senml_json_test_data_and_compare(const char *uriStr, lwm2m_media_type_t format, lwm2m_data_t *tlvP,
 ...
 */
static void senml_json_test_raw(const char *uriStr, const uint8_t *testBuf, size_t testLen, lwm2m_media_type_t format,
                                const char *id) {
    lwm2m_data_t *tlvP;
    lwm2m_uri_t uri;
    int size;
...
static void senml_json_test_raw_expected(const char *uriStr, const uint8_t *testBuf, size_t testLen,
                                         const char *expectBuf, size_t expectLen, lwm2m_media_type_t format,
                                         const char *id) {
    lwm2m_data_t *tlvP;
    lwm2m_uri_t uri;
    int size;
...
static void senml_json_test_raw_error(const char *uriStr, const uint8_t *testBuf, size_t testLen,
...
static void senml_json_test_2(void) {
    ...
    senml_json_test_raw_expected("/72", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "2");
#endif
}
...
static void senml_json_test_8(void) {
    ...
    const char *expect = "[{\"bn\":\"/65/543/\",\"n\":\"0\",\"vs\":\"LWM2M\"},"
                         ...
                         "{\"n\":\"2/0\",\"vb\":true},"
                         "{\"n\":\"2/1\",\"vb\":false}]";
    senml_json_test_raw_expected("/65/543", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "8");
}
...
static void senml_json_test_9(void) {
    ...
    senml_json_test_raw_expected("/2/3", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "9");
}
...
static void senml_json_test_10(void) {
    ...
    const char *expectA = "[{\"n\":\"/12/0/1\",\"v\":1234},{\"n\":\"/12/0/3\",\"v\":56.789},{\"n\":\"/12/0/2/"
                          "0\",\"v\":0.23},{\"n\":\"/12/0/2/1\",\"v\":-52.0006}]";
    const char *expectB = "[{\"bn\":\"/\",\"n\":\"12/0/1\",\"v\":1234},{\"n\":\"12/0/3\",\"v\":56.789},{\"n\":\"12/0/2/"
                          "0\",\"v\":0.23},{\"n\":\"12/0/2/1\",\"v\":-52.0006}]";
    const char *expectC = "[{\"bn\":\"/12/\",\"n\":\"0/1\",\"v\":1234},{\"n\":\"0/3\",\"v\":56.789},{\"n\":\"0/2/"
                          "0\",\"v\":0.23},{\"n\":\"0/2/1\",\"v\":-52.0006}]";
    const char *expectD = "[{\"bn\":\"/12/0/\",\"n\":\"1\",\"v\":1234},{\"n\":\"3\",\"v\":56.789},{\"n\":\"2/"
                          "0\",\"v\":0.23},{\"n\":\"2/1\",\"v\":-52.0006}]";
    const char *expectE = "[{\"bn\":\"/12/0/3\",\"v\":56.789}]";

    senml_json_test_raw_expected(NULL, (uint8_t *)buffer, strlen(buffer), expectA, strlen(expectA),
                                 LWM2M_CONTENT_SENML_JSON, "10a");
    senml_json_test_raw_expected("/", (uint8_t *)buffer, strlen(buffer), expectB, strlen(expectB),
                                 LWM2M_CONTENT_SENML_JSON, "10b");
    senml_json_test_raw_expected("/12", (uint8_t *)buffer, strlen(buffer), expectC, strlen(expectC),
                                 LWM2M_CONTENT_SENML_JSON, "10c");
    senml_json_test_raw_expected("/12/0", (uint8_t *)buffer, strlen(buffer), expectD, strlen(expectD),
                                 LWM2M_CONTENT_SENML_JSON, "10d");
    senml_json_test_raw_expected("/12/0/3", (uint8_t *)buffer, strlen(buffer), expectE, strlen(expectE),
                                 LWM2M_CONTENT_SENML_JSON, "10e");
}
...
static void senml_json_test_14(void) {
    ...
    senml_json_test_raw_expected("/5/0/1", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "14a");

    senml_json_test_raw_expected("/5/0/1/1", (uint8_t *)buffer, strlen(buffer), expect2, strlen(expect2),
                                 LWM2M_CONTENT_SENML_JSON, "14b");
}
...
static void senml_json_test_15(void) {
    ...
    senml_json_test_raw_expected("/5/0", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "15");
}
...
static void senml_json_test_17(void) {
    ...
    const char *expect = "[{\"n\":\"/65/0/0/0\",\"vlo\":\"66:0\"},"
                         ...
                         "{\"n\":\"/67/0/0\",\"vs\":\"85.76.76.84\"},"
                         "{\"n\":\"/67/0/1\",\"vs\":\"85.76.255.255\"}]";
    senml_json_test_raw_expected(NULL, (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "17");
}
...
static void senml_json_test_20(void) {
    ...
    senml_json_test_raw_expected("/34/0/", (uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "20");
}
...
static void senml_json_test_24(void) {
    ...
    const char *buffer = "[{\"bn\":\"/34/0/"
                         ...
                         "\\u000D\\u000E\\u000F\\u0010\\u0011\\u0012\\u0013\\u0014\\u0015\\u0016\\u0017\\u0018\\u0019\\"
                         "u001a\\u001b\\u001c\\u001d\\u001e\\u001f\\u0020\\\"\\\\\\/\\b\\f\\n\\r\\t\"}]";
    const char *expect = "[{\"bn\":\"/34/0/"
                         "2\",\"vs\":"
                         "\"\\u0000\\u0001\\u0002\\u0003\\u0004\\u0005\\u0006\\u0007\\b\\t\\n\\u000B\\f\\r\\u000E\\u000"
                         "F\\u0010\\u0011\\u0012\\u0013\\u0014\\u0015\\u0016\\u0017\\u0018\\u0019\\u001A\\u001B\\u001C"
                         "\\u001D\\u001E\\u001F \\\"\\\\/\\b\\f\\n\\r\\t\"}]";
    senml_json_test_raw_expected("/34/0/2", (const uint8_t *)buffer, strlen(buffer), expect, strlen(expect),
                                 LWM2M_CONTENT_SENML_JSON, "24a");
    senml_json_test_data_and_compare("/34/0/2", LWM2M_CONTENT_SENML_JSON, dataP, 1, "24b", (const uint8_t *)expect,
                                     strlen(expect));
    lwm2m_data_free(1, dataP);
}
...
static void senml_json_test_25(void) {
    ...
    senml_json_test_data_and_compare("/4", LWM2M_CONTENT_SENML_JSON, data1, 1, "25a", (const uint8_t *)expect1,
                                     strlen(expect1));
    senml_json_test_data_and_compare("/4/0", LWM2M_CONTENT_SENML_JSON, data1, 1, "25b", (const uint8_t *)expect2,
                                     strlen(expect2));
    senml_json_test_data_and_compare("/4/0", LWM2M_CONTENT_SENML_JSON, data2, 1, "25c", (const uint8_t *)expect2,
                                     strlen(expect2));
    senml_json_test_data_and_compare("/4/0/1", LWM2M_CONTENT_SENML_JSON, data1, 1, "25d", (const uint8_t *)expect3,
                                     strlen(expect3));
    senml_json_test_data_and_compare("/4/0/1", LWM2M_CONTENT_SENML_JSON, data2, 1, "25e", (const uint8_t *)expect3,
                                     strlen(expect3));
    senml_json_test_data_and_compare("/4/0/1", LWM2M_CONTENT_SENML_JSON, data3, 1, "25f", (const uint8_t *)expect3,
                                     strlen(expect3));
    senml_json_test_data_and_compare("/4/0/1/0", LWM2M_CONTENT_SENML_JSON, data1, 1, "25g", (const uint8_t *)expect4,
                                     strlen(expect4));
    senml_json_test_data_and_compare("/4/0/1/0", LWM2M_CONTENT_SENML_JSON, data2, 1, "25h", (const uint8_t *)expect4,
                                     strlen(expect4));
    senml_json_test_data_and_compare("/4/0/1/0", LWM2M_CONTENT_SENML_JSON, data3, 1, "25i", (const uint8_t *)expect4,
                                     strlen(expect4));
    senml_json_test_data_and_compare("/4/0/1/0", LWM2M_CONTENT_SENML_JSON, data4, 1, "25j", (const uint8_t *)expect4,
                                     strlen(expect4));
